...
export const DEPARTMENT_CODES: DepartmentCodeInfo[] = [
  ...
  },
  {
   ...
   name: 'отдел цифровых технологий и автоматизации',
    code: 'ТТ',
    description: 'цифровые технологии, автоматизация',
    keywords: ['технологии', 'цифра', 'автоматизация', 'программист', 'приложения', 'начальник отдела цифровых технологий и автоматизации','программист приложений']
];
